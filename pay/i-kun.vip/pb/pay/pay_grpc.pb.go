...
const (
	Pay_Ping_FullMethodName = "/pay.Pay/Ping"
)
...
func (c *payClient) Ping(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
	...
	out := new(Response)
	err := c.cc.Invoke(ctx, Pay_Ping_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Pay_Ping_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Pay_Ping_FullMethodName,
	}
...
const (
	OrderPay_OrderPay_FullMethodName = "/pay.OrderPay/OrderPay"
)
...
func (c *orderPayClient) OrderPay(ctx context.Context, in *OrderPayReq, opts ...grpc.CallOption) (*OrderPayResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(OrderPayResp)
	err := c.cc.Invoke(ctx, OrderPay_OrderPay_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedOrderPayServer must be embedded to have
// forward compatible implementations.
//
// NOTE: this should be embedded by value instead of pointer to avoid a nil
// pointer dereference when methods are called.
...
func (UnimplementedOrderPayServer) OrderPay(context.Context, *OrderPayReq) (*OrderPayResp, error) {
...
func (UnimplementedOrderPayServer) testEmbeddedByValue()                  {}
...
func RegisterOrderPayServer(s grpc.ServiceRegistrar, srv OrderPayServer) {
	// If the following call pancis, it indicates UnimplementedOrderPayServer was
	// embedded by pointer and is nil.  This will cause panics if an
	// unimplemented method is ever invoked, so we test this at initialization
	// time to prevent it from happening at runtime later due to I/O.
	if t, ok := srv.(interface{ testEmbeddedByValue() }); ok {
...
func _OrderPay_OrderPay_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(OrderPayReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(OrderPayServer).OrderPay(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: OrderPay_OrderPay_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OrderPayServer).OrderPay(ctx, req.(*OrderPayReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var OrderPay_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "pay.OrderPay",
	HandlerType: (*OrderPayServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "OrderPay",
			Handler:    _OrderPay_OrderPay_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "pay.proto",
