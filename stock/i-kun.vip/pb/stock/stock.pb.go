...
const file_stock_proto_rawDesc = "" +
	"\n" +
	"\vstock.proto\x12\x05stock\"\x1d\n" +
	"\aRequest\x12\x12\n" +
	"\x04ping\x18\x01 \x01(\tR\x04ping\"\x1e\n" +
	"\bResponse\x12\x12\n" +
	"\x04pong\x18\x01 \x01(\tR\x04pong20\n" +
	"\x05Stock\x12'\n" +
	"\x04Ping\x12\x0e.stock.Request\x1a\x0f.stock.ResponseB\x16Z\x14./i-kun.vip/pb/stockb\x06proto3"
...
var file_stock_proto_depIdxs = []int32{
	0, // 0: stock.Stock.Ping:input_type -> stock.Request
	1, // 1: stock.Stock.Ping:output_type -> stock.Response
